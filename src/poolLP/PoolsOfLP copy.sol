    ...
    ReentrancyGuard
{
    ...
    uint256 private _countInteract;
    ...
    function stakingLP(
        ...
        whenNotPaused
        nonReentrant
        onlyInvited(_inviter, _signature)
        returns (bool)
    {
    ...
    function unStakeLP() external whenNotPaused nonReentrant returns (bool) {
        ...
        unchecked {
            ...
            require(_amountLP <= totalStakingLP, "");
    ...
    function unStakeLP2(
        ...
        require(_amountRemove <= _stakeLPData.amountLP, "");
        ...
        unchecked {
            ...
            require(_amountRemove <= totalStakingLP, "");
